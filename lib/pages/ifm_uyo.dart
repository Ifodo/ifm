...
import 'package:inspiration/pages/latest_news_uy.dart';
...
import 'package:inspiration/pages/video_live_streamUy.dart';
import 'package:inspiration/services/webservices.dart';
import 'package:loading_gifs/loading_gifs.dart';

class IFMUyo extends StatefulWidget {
  const IFMUyo({super.key});

  @override
  _IFMUyoState createState() => _IFMUyoState();
}

class _IFMUyoState extends State<IFMUyo> {
  @override
  Widget build(BuildContext context) {
    var screenWidth = MediaQuery.of(context).size.width;
    var screenHeight = MediaQuery.of(context).size.height;
    var stationName = 'ifm1059';
    return Container(
      ...
      child: Column(
        children: [
          ...
          const Expanded(
            child: Center(child: LatestNewsUy()),
          )
        ],
      ),
    );
...
navigateToStream(context) {
  ...
  Navigator.push(
      ...
      MaterialPageRoute(builder: (context) => const VideoLiveStreamUy()));
}
